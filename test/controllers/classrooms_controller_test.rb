...
class ClassroomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create classroom" do
    assert_difference('Classroom.count') do
      post classrooms_url, params: { classroom: { grade: @classroom.grade, school_id: @classroom.school_id, subject: @classroom.subject, user_id: @classroom.user_id } }
    end
  ...
  test "should update classroom" do
    patch classroom_url(@classroom), params: { classroom: { grade: @classroom.grade, school_id: @classroom.school_id, subject: @classroom.subject, user_id: @classroom.user_id } }
